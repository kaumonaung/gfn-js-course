/*
===== Aufgaben ====
1) Füge eine Validierung hinzu, die sicherstellt, dass der Zähler nicht unter 0 fällt. Zeige einen Alert an, wenn der Benutzer versucht, den Zähler unter 0 zu setzen.

2) Wenn der Zähler resetet wird, zeige eine Bestätigungsaufforderung (confirm()) an, die den Benutzer fragt, ob er den Zähler wirklich zurücksetzen möchte.
 
3) Erstelle einen neuen Button, der den Zähler verdoppelt.
===================
*/
